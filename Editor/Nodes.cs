...
namespace UniNoise.Editor
{
      public sealed class Nodes : MonoBehaviour
      {
            public abstract class Node
            {
                  ...
                  {
                        var inputPortRect = new Rect(Rect.x - 10, Rect.y + Rect.height * 0.5f - 5, 10, 10);
                        var outputPortRect = new Rect(Rect.x + Rect.width, Rect.y + Rect.height * 0.5f - 5, 10, 10);
                  ...
                  private static void ProcessContextMenu()
                  {
